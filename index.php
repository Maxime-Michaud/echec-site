...
<html>
    ...
    <body onresize="setSquare()" onload="setSquare()" class="col-xs-offset-3 col-xs-8">
        <div id="grille">
            <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/js/bootstrap.min.js" integrity="sha384-0mSbJDEHialfmuBBQP6A4Qrprq5OVfW37PRR3j5ELqxss1yVqOtnepnHVP9aJ7xS" crossorigin="anonymous"></script>
            <div class="row" id="row">
                <divCase1 class="col-xs-1" id="case00"></divCase1>
            ...
            <div class="row">
                <divCase2 class="col-xs-1" id="case10"></divCase2>
            ...
            <div class="row">
                <divCase1 class="col-xs-1" id="case20"></divCase1>
             ...
             <div class="row">
                <divCase2 class="col-xs-1" id="case30"></divCase2>
            ...
            <div class="row">
                <divCase1 class="col-xs-1" id="case40"></divCase1>
            ...
            <div class="row">
                <divCase2 class="col-xs-1" id="case50"></divCase2>
            ...
            <div class="row">
                <divCase1 class="col-xs-1" id="60"></divCase1>
            ...
            <div class="row">
                <divCase2 class="col-xs-1" id="case70"></divCase2>
